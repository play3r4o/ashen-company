...
func run_smoke() -> void:
	...
	check(game.ui_root.find_child("SkillNodes", true, false) != null and game.ui_root.find_child("SkillNode_braced_stance", true, false) != null, "field skill tree opens with expandable nodes")
	game._show_camp()
